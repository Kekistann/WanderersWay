...
Visuals are carried by Community Shaders and it's official add-ons. Lux CS and NAT.CS create believable lighting which looks natural but still captures a touch of fantasy. Featuring a near total PBR overhaul, material will react to light similarly to what you see in modern games. Vanilla AIO PBR serves as a base-line, retaining Skyrim's original art-style but enhancing it with Parallax and PBR material. Locational overhauls were something I battled with for a long time. If I couldn't find an overhaul I liked, I didn't include one just for the sake of having something modded.  
